...
- 当前任务为“第三章第4-6节分卷”生成，按章节标题与正文语义判断内容归属。
- **第三章内容边界（强约束）**：当前分卷仅覆盖“第三章第4-6节”。
  - 允许：第四节、第五节、第六节。
  - 一律跳过：第一章、第二章、第三章第1-3节，以及第三章第7节及之后的内容（若有附录/索引等也跳过）。
- 在本分卷中，仅按第三章规则生成 QA 类型：
  - **第三章（舌诊临床辨证各论）只允许 2 类 QA**  
    - 舌象特征类  
    - 提示的病症/证候类  
...
7. 第一章与第二章内容一律不生成；第三章仅保留第4-6节；分卷文件内页码仅作顺序参考，不作为章节起始判定条件。
...
Reminder: this run generates only Chapter 3 Sections 4-6; skip Chapter 1, Chapter 2, and Chapter 3 Sections 1-3 and 7-11.
"""
        return PROMPT
