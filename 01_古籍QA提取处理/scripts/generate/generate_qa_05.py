...
def main():
    """主函数 - 批量处理05_diagnostics/standard目录下所有文件"""

    # 目录配置
    INPUT_DIR = PROJECT_ROOT / "中医古籍分类/05_diagnostics/standard"
    CHECKPOINT_DIR = PROJECT_ROOT / "qa_output/05_diagnostics"    # 旧输出，用于读断点
    OUTPUT_DIR = PROJECT_ROOT / "qa_output_v2/05_diagnostics"     # 新输出
