...
def main():
    """主函数 - 批量处理02_formulas/standard目录下所有文件"""

    # 目录配置
    INPUT_DIR = PROJECT_ROOT / "中医古籍分类/02_formulas/standard"
    CHECKPOINT_DIR = PROJECT_ROOT / "qa_output/02_formulas"       # 旧输出，用于读断点
    OUTPUT_DIR = PROJECT_ROOT / "qa_output_v2/02_formulas"        # 新输出
