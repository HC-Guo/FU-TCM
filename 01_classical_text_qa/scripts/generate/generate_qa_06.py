...
def main():
    """主函数 - 批量处理06_wellness/standard目录下所有文件"""

    # 目录配置
    INPUT_DIR = PROJECT_ROOT / "中医古籍分类/06_wellness/standard"
    CHECKPOINT_DIR = PROJECT_ROOT / "qa_output/06_wellness"       # 旧输出，用于读断点
    OUTPUT_DIR = PROJECT_ROOT / "qa_output_v2/06_wellness"        # 新输出
